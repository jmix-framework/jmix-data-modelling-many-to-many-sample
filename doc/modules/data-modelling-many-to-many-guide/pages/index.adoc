...
image::petclinic_visit_treatment_room_link.png[alt=“Database Representation of Visit and Treatment Room”, title=“Database Representation of Visit and Treatment Room Many-To-Many Association”]
...
There are three dimensions that categorize how many-to-many associations and managed on the application level. Let’s briefly examine these dimensions before diving into specific examples in the following sections.
...
image::specialty_detail_view_no_veterinarians.png[alt="Specialty Detail View without Veterinarian Section", title="Specialty Detail View without Veterinarian Section"]
